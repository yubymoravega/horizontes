...
<html lang=\"es\">
  ...
  <body>
    ...
    <form id=\"payment-form\">
      <input type=\"number\" id=\"monto\" style=\"border-color: green; text-align: center;\" disabled name='monto'placeholder=\"Monto a cobrar \$";
        // line 22
        echo twig_escape_filter($this->env, (isset($context["monto"]) || array_key_exists("monto", $context) ? $context["monto"] : (function () { throw new RuntimeError('Variable "monto" does not exist.', 22, $this->source); })()), "html", null, true);
        echo "\" />
...
";
    ...
    {
        return array (  94 => 22,  83 => 14,  78 => 12,  68 => 4,  58 => 3,  35 => 1,);
    }
...
<html lang=\"es\">
  ...
  <body>
    ...
    <!-- Display a payment form -->
    <form id=\"payment-form\">
      <input type=\"number\" id=\"monto\" style=\"border-color: green; text-align: center;\" disabled name='monto'placeholder=\"Monto a cobrar \${{monto}}\" />
      <div id=\"card-element\"><!--Stripe.js injects the Card Element--></div>
