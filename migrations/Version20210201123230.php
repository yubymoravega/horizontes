 ...
 */
final class Version20210201123230 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE operaciones_comprobante_operaciones ADD id_instrumento_cobro_id INT NOT NULL');
