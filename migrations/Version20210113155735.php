 ...
 */
final class Version20210113155735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       */ $this->addSql('ALTER TABLE factura_imposdom ADD lb VARCHAR(255) NOT NULL');/*
    ...
    public function down(Schema $schema) : void
    {
      /*  // this down() migration is auto-generated, please modify it to your needs
        ...
        $this->addSql('ALTER TABLE factura_imposdom DROP lb');
