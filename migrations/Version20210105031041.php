 ...
 */
final class Version20210105031041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE operaciones_comprobante_operaciones CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE operaciones_comprobante_operaciones CHANGE id id INT NOT NULL');
