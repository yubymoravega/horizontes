 ...
 */
final class Version20200930145654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE documento (id INT AUTO_INCREMENT NOT NULL, id_almacen_id INT NOT NULL, id_unidad_id INT NOT NULL, id_moneda_id INT NOT NULL, importe_total DOUBLE PRECISION NOT NULL, fecha DATE NOT NULL, activo TINYINT(1) NOT NULL, INDEX IDX_B6B12EC739161EBF (id_almacen_id), INDEX IDX_B6B12EC71D34FA6B (id_unidad_id), INDEX IDX_B6B12EC7374388F5 (id_moneda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, id_amlacen_id INT NOT NULL, id_unidad_medida_id INT NOT NULL, codigo VARCHAR(255) NOT NULL, cuenta VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, existencia DOUBLE PRECISION NOT NULL, importe DOUBLE PRECISION NOT NULL, activo TINYINT(1) NOT NULL, INDEX IDX_A7BB0615E2C70A62 (id_amlacen_id), INDEX IDX_A7BB0615E16A5625 (id_unidad_medida_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
