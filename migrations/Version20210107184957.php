 ...
 */
final class Version20210107184957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       // $this->addSql('CREATE TABLE comprobante_movimiento_activo_fijo (id INT AUTO_INCREMENT NOT NULL, id_registro_comprobante_id INT NOT NULL, id_movimiento_activo_id INT NOT NULL, id_unidad_id INT NOT NULL, anno INT NOT NULL, INDEX IDX_81F5096A1399A3CF (id_registro_comprobante_id), INDEX IDX_81F5096A9D00B230 (id_movimiento_activo_id), INDEX IDX_81F5096A1D34FA6B (id_unidad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE factura_imposdom (id INT AUTO_INCREMENT NOT NULL, id_cliente VARCHAR(255) NOT NULL, cedula VARCHAR(255) NOT NULL, casillero VARCHAR(255) NOT NULL, ciudad VARCHAR(255) NOT NULL, sh VARCHAR(255) NOT NULL, json VARCHAR(5000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
     ...
     /*   $this->addSql('DROP TABLE comprobante_movimiento_activo_fijo');
        ...
        $this->addSql('ALTER TABLE depreciacion ADD CONSTRAINT FK_D618AE145832E72E FOREIGN KEY (id_activo_fijo_id) REFERENCES activo_fijo (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
