 ...
 */
final class Version20210108145626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       */ $this->addSql('ALTER TABLE factura_imposdom ADD cierre VARCHAR(255) NOT NULL, ADD pago VARCHAR(255) NOT NULL');/*
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE factura_imposdom DROP cierre, DROP pago');
