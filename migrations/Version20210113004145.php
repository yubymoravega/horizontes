 ...
 */
final class Version20210113004145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movimiento_activo_fijo ADD fecha_factura DATE DEFAULT NULL, ADD nro_factura VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movimiento_activo_fijo DROP fecha_factura, DROP nro_factura');
    }
}
