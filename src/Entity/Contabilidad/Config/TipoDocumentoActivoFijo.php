...
use App\Repository\Contabilidad\Config\TipoDocumentoActivoFijoRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bridge\Doctrine\Validator\Constraints\UniqueEntity;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * @ORM\Entity(repositoryClass=TipoDocumentoActivoFijoRepository::class)
 * @UniqueEntity("descripcion",message="contabilidad.config.descripcion_unique")
 */
class TipoDocumentoActivoFijo
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
