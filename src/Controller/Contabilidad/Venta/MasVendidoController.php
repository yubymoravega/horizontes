...
/**
 * Class MasVendidoController
 * @package App\Controller\Contabilidad\Venta
 * @Route("/contabilidad/venta/productos-mas-vendidos")
 */
class MasVendidoController extends AbstractController
{
    /**
     * @Route("/", name="contabilidad_venta_mas_vendido")
     */
    public function index(EntityManagerInterface $em, Request $request)
    {
        ...
        AuxFunctions::array_sort_by($productos, 'cant_productos', $order = SORT_DESC);
        AuxFunctions::array_sort_by($mercancias, 'cant_productos', $order = SORT_DESC);

        return $this->render('contabilidad/venta/mas_vendido/index.html.twig', [
