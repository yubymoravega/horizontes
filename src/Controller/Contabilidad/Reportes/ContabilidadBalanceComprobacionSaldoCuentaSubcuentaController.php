...
/**
 * Class ContabilidadBalanceComprobacionSaldoCuentaSubcuentaController
 * @package App\Controller\Contabilidad\Reportes
 * @Route("/contabilidad/reportes/balance-comprobacion-saldo-cuenta-subcuenta")
 */
class ContabilidadBalanceComprobacionSaldoCuentaSubcuentaController extends ControllerContabilidadReport
{
    private $TIPO_CUENTA = 1;
    private $TIPO_SUBCUENTA = 2;
    /**
     * @Route("/", name="contabilidad_reportes_contabilidad_balance_comprobacion_saldo_cuenta_subcuenta")
     */
    ...
    /**
     * @Route("/print", name="contabilidad_reportes_balance_comprobacion_cuenta_sub_print")
     */
    public function print(EntityManagerInterface $em, Request $request, PaginatorInterface $pagination)
    {
        ...
        $list_balance_comprobacion = $this->getData($em);
        return $this->render('contabilidad/reportes/contabilidad_balance_comprobacion_saldo_cuenta_subcuenta/print.html.twig', [
