...
/**
 * Class ActivoFijoDepreciacionController
...
class ActivoFijoDepreciacionController extends ControllerContabilidadReport
{
    ...
    {
        return $this->render('contabilidad/reportes/activo_fijo_depreciacion/index.html.twig', [
            'controller_name' => 'ActivoFijoDepreciacionController',
    ...
    /**
     * @Route("/print-depreciacion", name="contabilidad_reportes_activo_fijo_print_depreciacion")
     */
