...
/**
 * Class ContabilidadCuentaPorPagarController
 * @package App\Controller\Contabilidad\Reportes
 * @Route("/contabilidad/reportes/contabilidad-cuenta-por-pagar")
 */
class ContabilidadCuentaPorPagarController extends ControllerContabilidadReport
{
    /**
     * @Route("/", name="contabilidad_reportes_contabilidad_cuenta_por_pagar")
     */
