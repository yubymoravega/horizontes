...
/**
 * Class ContabilidadMovimientoCuentasController
 * @package App\Controller\Contabilidad\Reportes
 * @Route("/contabilidad/reportes/contabilidad-movimiento-cuentas")
 */
class ContabilidadMovimientoCuentasController extends ControllerContabilidadReport
{
    /**
     * @Route("/", name="contabilidad_reportes_contabilidad_movimiento_cuentas")
     */
    ...
    /**
     * @Route("/getSubmayor", name="contabilidad_reporte_movimiento_cuenta_get", methods={"POST","GET"})
     */
...
//        dd($params[0],$arr_asientos);
    ...
    /**
     * @Route("/getDatos", name="contabilidad_reporte_movimiento_cuenta_get_dato", methods={"POST"})
     */
