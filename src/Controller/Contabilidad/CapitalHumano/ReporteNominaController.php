...
class ReporteNominaController extends AbstractController
{
    ...
    /**
     * @Route("/nominas-empleados", name="contabilidad_capital_humano_reporte_nomina_epmpleados")
     */
    public function index_nominas_empleados()
    {
        return $this->render('contabilidad/capital_humano/reporte_nomina_empleados/index.html.twig', [
            'controller_name' => 'ReporteNominaController',
        ]);
    }
    /**
