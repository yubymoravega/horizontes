        ...
        foreach ($arr_cuentas as $cuenta) {
            ...
            if (!empty($arr_subcuentas)) {
                ...
                foreach ($arr_subcuentas as $subcuenta) {
                    ...
                    $data_analisis = $this->getDataByParams($data_almacenes, $cuenta->getNroCuenta(), $subcuenta->getNroSubcuenta(), Date('m'), Date('Y'));
                    ...
                    foreach ($data_analisis as $data) {
                        ...
                        $row[] = array(
                            ...
                            'debito_mes' => $data['credito_mes'] > 0 ? number_format($data['credito_mes'], 2) : '',
...
//        /***Criterio de analisis 2*/
//        $repet_criteria = [];
//        foreach ($rows_data as $data) {
//            if (!in_array($data['analisis_2'], $repet_criteria) && $data['nro_cuenta'] == $cuenta && $data['nro_subcuenta'] == $subcuenta)
//                $repet_criteria[count($repet_criteria)] = $data['analisis_2'];
//        }
//        foreach ($repet_criteria as $criteria) {
//            $total_debito = 0;
//            $total_credito = 0;
//            foreach ($rows_data as $data) {
//                if ($data['analisis_2'] == $criteria && $data['nro_cuenta'] == $cuenta && $data['nro_subcuenta'] == $subcuenta) {
//                    $total_debito += AuxFunctions::getNumberByString($data['debito']);
//                    $total_credito += AuxFunctions::getNumberByString($data['credito']);
//                }
//            }
...
//            );
//        }
//        /*** Criterio de analisis 3*/
//        $repet_criteria = [];
//        foreach ($rows_data as $data) {
//            if (!in_array($data['analisis_3'], $repet_criteria) && $data['nro_cuenta'] == $cuenta && $data['nro_subcuenta'] == $subcuenta)
//                $repet_criteria[count($repet_criteria)] = $data['analisis_3'];
//        }
//        foreach ($repet_criteria as $criteria) {
//            $total_debito = 0;
//            $total_credito = 0;
//            foreach ($rows_data as $data) {
//                if ($data['analisis_3'] == $criteria && $data['nro_cuenta'] == $cuenta && $data['nro_subcuenta'] == $subcuenta) {
//                    $total_debito += AuxFunctions::getNumberByString($data['debito']);
//                    $total_credito += AuxFunctions::getNumberByString($data['credito']);
//                }
//            }
