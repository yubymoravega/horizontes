 ...
 * @Route("/contabilidad/general/cuenta-por-cobrar")
 */
class CuentaPorCobrarController extends AbstractController
{
    /**
     * @Route("/", name="contabilidad_general_cuenta_por_cobrar")
     */
...
//        $today = AuxFunctions::getCurrentDate($em, $unidad);
        ...
        return $this->render('contabilidad/general/cuenta_por_cobrar/index.html.twig', [
