...
/**
 * Class TrasladosEnviadosController
 * @package App\Controller\Contabilidad\ActivoFijo
 * @Route("/contabilidad/activo-fijo/traslados-enviados")
 */
class TrasladosEnviadosController extends AbstractController
{
    protected $tipo_movimiento = 4;

    /**
     * @Route("/", name="contabilidad_activo_fijo_traslados_enviados")
     */
...
//                return $this->render('contabilidad/activo_fijo/traslados_enviados/index.html.twig', [
...
//            }
    ...
    /**
     * @Route("/getCuentas", name="contabilidad_activo_fijo_traslado_enviado_get_cuentas", methods={"POST"})
     */
    ...
    /**
     * @Route("/getNroInv/{nro_inv}", name="contabilidad_activo_fijo_traslado_enviado_get_nro_inv", methods={"POST"})
     */
    ...
    /**
     * @Route("/getTraslado/{nro}", name="contabilidad_activo_fijo_traslado_enviado_get_traslado", methods={"POST"})
     */
